...
if __name__ == "__main__":
    ...
    #filename = "data/rms3_d03_20200416Z1200.nc4"
    
    #filename = "http://data.meteo.uniparthenope.it/opendap/opendap/ww33/d01/archive/2020/03/29/ww33_d01_20200329Z1200.nc"
    filename = "data/ww33_d01_20200329Z1200.nc4"
    
    
    #filename = "data/rdr1_d04_20180424Z0730.nc4"
    #filename = "data/rdr2_d04_20190202Z0300.nc4"
    #filename = "data/wrf5_d01_20200416Z1200.nc4"
                    ...
                    for count_lon in range(1, div_lon_x+1):
                        ...
                        # Se siamo in una variabile con lat e lon (senza tempo)
                            ...
                            if (len(dimension_names) == 2):
                                ...
                                slice_t = variable [start_lat[count_lat-1]:end_lat[count_lat-1] +1, # prima dimensione
